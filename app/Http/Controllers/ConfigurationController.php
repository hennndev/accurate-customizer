...
class ConfigurationController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'down_payment_purchase_invoice_number_source' => 'required|in:mapping_table,transaction_number_mappings',
        ...
        $setting->update([
            ...
            'down_payment_purchase_invoice_number_source' => $validated['down_payment_purchase_invoice_number_source'],
