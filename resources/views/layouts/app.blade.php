...
<body class="font-sans antialiased bg-gray-50">
      ...
      <div class="p-7">
        <div class="flex flex-col gap-7">
          <div class="flex flex-col gap-3">
            <p class="text-[12px] text-gray-500 font-bold tracking-wider leading-4 sidebar-section-title mb-1">MENU UTAMA</p>
            <div class="flex flex-col gap-1">
              <a href="{{ route('modules.index') }}"
                ...
                <p class="text-[14px] sidebar-text font-medium">Capture Data (Ambil)</p>
              </a>
              <a href="{{ route('migrate.index') }}"
                ...
                <p class="text-[14px] sidebar-text font-medium">Migrate Data (Kirim)</p>
              </a>
              <a href="{{ route('transaction-number-mappings.index') }}"
                ...
                <p class="text-[14px] sidebar-text font-medium">Pemetaan Nomor</p>
              </a>
              <a href="{{ route('system-logs.index') }}"
                ...
                <p class="text-[14px] sidebar-text font-medium">Log Aktivitas</p>
              </a>
              <a href="{{ route('system-logs.queue') }}"
                ...
                <p class="text-[14px] sidebar-text font-medium">Antrean Background</p>
              </a>
            </div>
          </div>
          <div class="flex flex-col gap-3">
            <p class="text-[12px] text-gray-500 font-bold tracking-wider leading-4 sidebar-section-title mb-1">PENGATURAN</p>
            <div class="flex flex-col gap-1">
              @can('manage_settings')
                <a href="{{ route('configuration.index') }}"
                  ...
                  <p class="text-[14px] sidebar-text font-medium">Pengaturan Aplikasi</p>
                </a>
              @endcan
              @can('manage_users')
                <a href="{{ route('users.index') }}"
                  ...
                  <p class="text-[14px] sidebar-text font-medium">Manajemen Pengguna</p>
                </a>
              @endcan
            </div>
          </div>
          ...
          <div class="flex items-center space-x-3 sm:space-x-5 flex-shrink-0">
            ...
            <div class="relative">
              ...
              <div id="dropdown"
                ...
                <x-dropdown-link href="{{ route('profile.edit') }}">Profil
                </x-dropdown-link>
  ...
  <div x-data="{ openOptions: false }" class="fixed bottom-6 right-6 z-50">
      <div x-show="openOptions" @click.away="openOptions = false" x-transition.opacity.duration.200ms class="absolute bottom-16 right-0 mb-2 w-56 bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100 overflow-hidden" style="display: none;">
          <div class="py-2">
              <div class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-50/50">Pemeliharaan</div>
  ...
  <script>
    function clearAllTransactions() {
        Swal.fire({
            ...
            text: "Apakah Anda yakin ingin menghapus seluruh data transaksi secara permanen? Tindakan ini tidak dapat dibatalkan.",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                ...
                .then(res => res.json())
                .then(data => {
                    Swal.fire("Terhapus!", data.message || "Semua transaksi telah dihapus.", "success")
    ...
    function clearAllLogs() {
        Swal.fire({
            ...
            text: "Apakah Anda yakin ingin menghapus seluruh log sistem dan antrean pekerjaan? Tindakan ini tidak dapat dibatalkan.",
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#ef4444",
            cancelButtonColor: "#6b7280",
            ...
            if (result.isConfirmed) {
                ...
                .then(res => res.json())
                .then(data => {
                    Swal.fire("Terhapus!", data.message || "Semua log sistem telah dihapus.", "success")
                    .then(() => window.location.reload());
                });
            }
        });
