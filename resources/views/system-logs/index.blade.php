...
<x-app-layout>
  ...
  <div class="flex flex-col gap-6 md:gap-8 lg:gap-10">
    <div class="w-full bg-gradient-to-r from-gray-700 to-gray-900 rounded-xl p-5 md:p-8 lg:p-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 lg:gap-7">
      ...
      <div class="flex border border-gray-200 min-h-[120px] md:min-h-[150px] items-center justify-between shadow-md rounded-xl bg-white p-5 md:p-7 md:pt-10">
        ...
        <svg xmlns="http://www.w3.org/2000/svg"
             ...
             stroke-width="1.5"
             stroke="currentColor"
             class="w-8 h-8 md:w-10 md:h-10 text-blue-300">
          <path stroke-linecap="round"
                stroke-linejoin="round"
    ...
    <div class="flex flex-col gap-4 md:gap-5 rounded-xl bg-white shadow-lg p-4 md:p-5 border border-gray-200">
      ...
      <form method="GET"
            action="{{ route('system-logs.index') }}"
        ...
        <div x-data="{ open: false, selected: '{{ request('event_type', 'All Types') }}' }"
             class="relative w-full md:flex-1">
          <input type="hidden"
                 name="event_type"
                 :value="selected !== 'All Types' ? selected : ''">
          ...
          <div x-show="open"
            ...
            <ul class="py-1">
              ...
              <li @click="selected = 'mass delete'; $nextTick(() => $el.closest('form').submit())"
                ...
                <svg x-show="selected === 'mass delete'"
                     xmlns="http://www.w3.org/2000/svg"
                     fill="none"
                     viewBox="0 0 24 24"
                     stroke-width="2"
              ...
              <li @click="selected = 'capture_queue'; $nextTick(() => $el.closest('form').submit())"
                  :class="selected === 'capture_queue' ? 'bg-blue-50' : ''"
                  class="px-4 py-2 text-gray-700 text-sm hover:bg-gray-100 cursor-pointer transition font-medium flex items-center justify-between">
                <span>Capture Queue</span>
                <svg x-show="selected === 'capture_queue'"
                     xmlns="http://www.w3.org/2000/svg"
                     fill="none"
                     viewBox="0 0 24 24"
                     stroke-width="2"
              ...
              <li @click="selected = 'migrate_queue'; $nextTick(() => $el.closest('form').submit())"
                  :class="selected === 'migrate_queue' ? 'bg-blue-50' : ''"
                  class="px-4 py-2 text-gray-700 text-sm hover:bg-gray-100 cursor-pointer transition font-medium flex items-center justify-between">
                <span>Migrate Queue</span>
                <svg x-show="selected === 'migrate_queue'"
                     xmlns="http://www.w3.org/2000/svg"
                     fill="none"
                     viewBox="0 0 24 24"
                     stroke-width="2"
              ...
              <div class="bg-gray-50 w-6 h-6 md:w-7 md:h-7 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                @elseif($log->status === 'warning')
                  <svg xmlns="http://www.w3.org/2000/svg"
                       ...
                       stroke-width="1.5"
                       stroke="currentColor"
                       class="w-4 h-4 md:w-5 md:h-5 text-yellow-600">
                    <path stroke-linecap="round"
                          stroke-linejoin="round"
        ...
        @empty
          <div class="text-center py-12">
            <svg xmlns="http://www.w3.org/2000/svg"
                 ...
                 stroke-width="1.5"
                 stroke="currentColor"
                 class="size-12 mx-auto text-gray-400 mb-3">
              <path stroke-linecap="round"
                    stroke-linejoin="round"
